...
int main()
{
	...
	*/
	...
	glm::mat4 modelC(1.0);
	glm::mat4 modelPD(1.0);
	glm::mat4 modelPI(1.0);

	glm::mat4 modelCola(1.0);
	glm::mat4 modelBD(1.0);
	glm::mat4 modelBI(1.0);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		if(seleccion == 1) {
			...
			//DIBUJAMOS llantas
			model = glm::translate(model, glm::vec3(0.0f, -1.75f, 3.1f));

			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			model = glm::scale(model, glm::vec3(2.0f, 0.5f, 2.0f));
			model = glm::rotate(model, glm::radians(mainWindow.getllanta_1()), glm::vec3(0.0f, 1.0f, 0.0f));
			...
			//Debido a que las ruedas de momento funcionan de manera individual se reiniciara el mat4 cada que creemos una
			model = glm::mat4(1.0);

			model = glm::translate(model, glm::vec3(6.0f, -1.75f, 3.1f));

			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			model = glm::scale(model, glm::vec3(2.0f, 0.5f, 2.0f));
			model = glm::rotate(model, glm::radians(mainWindow.getllanta_2()), glm::vec3(0.0f, 1.0f, 0.0f));
			...
			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			model = glm::scale(model, glm::vec3(2.0f, 0.5f, 2.0f));
			model = glm::rotate(model, glm::radians(mainWindow.getllanta_3()), glm::vec3(0.0f, 1.0f, 0.0f));
			...
			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			model = glm::scale(model, glm::vec3(2.0f, 0.5f, 2.0f));
			model = glm::rotate(model, glm::radians(mainWindow.getllanta_4()), glm::vec3(0.0f, 1.0f, 0.0f));
			...
			//Se crea el modelo de la base piramidal
			...
			modelaux = model;
			model = glm::scale(model, glm::vec3(1.5f, 0.75f, 2.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			color = glm::vec3(1.0f, 0.8f, 0.0f);
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
	...
	if (seleccion == 0) {
		...
		model = glm::translate(model, glm::vec3(-0.75f, 4.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2() + 60), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = glm::translate(model, glm::vec3(-1.0f, 0.95f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4() - 75), glm::vec3(0.0f, 0.0f, 1.0f));
		modelPD = model;
		...
		model = modelPD;
		model = glm::translate(model, glm::vec3(0.5f, -1.75f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5() + 40), glm::vec3(0.0f, 0.0f, 1.0f));
		modelPD = model;
		...
		//Brazo base derecho
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.8f, 1.5f, -1.7f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8() -65), glm::vec3(0.0f, 0.0f, 1.0f));
		modelBD = model;
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9() - 80), glm::vec3(0.0f, 0.0f, 1.0f));
		modelBD = model;
		model = glm::scale(model, glm::vec3(0.5f, 1.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion12() + 30), glm::vec3(0.0f, 0.0f, 1.0f));
		modelCola = model;
		...
		//Cola cacho final
		model = modelCola;
		model = glm::translate(model, glm::vec3(0.6f, -2.2f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion13() + 30), glm::vec3(0.0f, 0.0f, 1.0f));
		modelCola = model;
